...
position: relative;
  ...
  display:flex;
  /* border-bottom: 1px solid ${palette.greys900}; */
`
...
export default function Link({ text, inline, forbio, url }) {
  const styleLinkWrapper = {
    display: inline ? "inline-block" : "flex",
    flexDirection: "row",
    justifyContent: forbio ? "start" : "center",
    alignItems: "center",
    overflow: "visible",
    paddingTop: forbio ? "20px" : "0px",
  }
